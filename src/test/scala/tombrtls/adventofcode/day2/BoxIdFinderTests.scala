...
class BoxIdFinderTests extends FunSpec with Matchers {
  ...
  it("should be able to tell when two strings have 1 character in difference") {
    BoxIdFinder.hasSingleCharacterDifference("abcdefg", "abcdefe") should be (true)
    BoxIdFinder.hasSingleCharacterDifference("abcdefg", "abedefg") should be (true)
    BoxIdFinder.hasSingleCharacterDifference("abcdefg", "abadedg") should be (false)
    BoxIdFinder.hasSingleCharacterDifference("abcdefg", "gfedcba") should be (false)
  }
